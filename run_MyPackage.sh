...
#TODO: replace with the proper modules on the cluster
module purge
...
#TODO: replace myenv by the name of your conda environment in the above script
#TODO: change the queue and specs you need on the cluster
